...
<body>
    ...
    <form method="POST">
    	...
    	<div class="question2">
	    	<input type="text" name="question2" placeholder="Question 2" class="question" required>
	    	<br/>
    	...
    	<div class="question3">
    		<input type="text" name="question3" placeholder="Question 3" class="question" required>
    		<br/>
    	...
    	<div class="question4">
    		<input type="text" name="question4" placeholder="Question 4" class="question" required>
    		<br/>
    	...
    	<div class="question5">
    		<input type="text" name="question5" placeholder="Question 5" class="question" required>
    		<br/>
    	...
    	<div class="question6">
    		<input type="text" name="question6" placeholder="Question 6" class="question" required>
    		<br/>
    	...
    	<div class="question7">
    		<input type="text" name="question7" placeholder="Question 7" class="question" required>
    		<br/>
    	...
    	<div class="question8">
    		<input type="text" name="question8" placeholder="Question 8" class="question" required>
    		<br/>
